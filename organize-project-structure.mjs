 ...
 * Create professional folder structure with test folders
 */
...
function moveFilesToStructure() {
  ...
  const fileMappings = [
    ...
    // Frontend pages
    { from: '../Client/src/pages/Profile.tsx', to: 'client/src/pages/profile/view/Profile.tsx' },
    { from: '../Client/src/pages/EditProfile.tsx', to: 'client/src/pages/profile/edit/EditProfile.tsx' },
    { from: '../Client/src/pages/Projects.tsx', to: 'client/src/pages/projects/Projects.tsx' },
    
    // Frontend components
    { from: '../Client/src/components/Navbar.tsx', to: 'client/src/components/common/layout/header/Navbar.tsx' },
    
    // Frontend services
    { from: '../Client/src/services/api-client.ts', to: 'client/src/services/api/api-client.ts' },
    { from: '../Client/src/services/auth.ts', to: 'client/src/services/auth/auth.ts' },
...
// Function to create index files for better organization
  ...
  const indexFiles = [
    {
      ...
      content: `// Backend library exports
export * from './auth';
...
`
    ...
    {
      path: 'backend/src/lib/auth/index.ts',
      content: `// Authentication exports
...
`
    ...
    {
      path: 'backend/src/lib/supabase/index.ts',
      content: `// Supabase exports
export * from './client';
export * from './server';
export * from './admin';
export * from './types';
`
    ...
    {
      path: 'backend/src/tests/index.ts',
      content: `// Test exports
export * from './unit';
...
// Function to create README files for each major folder
...
async function organizeProject() {
  try {
    ...
    console.log('3. Created index files for better imports');
    console.log('4. Added README files for documentation');
    console.log('5. Organized test files in dedicated folders');
    console.log('6. Separated concerns properly');
